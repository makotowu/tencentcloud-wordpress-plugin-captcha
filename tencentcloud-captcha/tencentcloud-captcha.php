...
define('TENCENT_WORDPRESS_CAPTCHA_VERSION', '1.0.6');
...
defined('TENCENT_WORDPRESS_CAPTCHA_URL') or define('TENCENT_WORDPRESS_CAPTCHA_URL', plugin_dir_url(__FILE__));
define('TENCENT_WORDPRESS_CAPTCHA_JS_DIR', TENCENT_WORDPRESS_CAPTCHA_URL . 'js' . '/');
define('TENCENT_WORDPRESS_CAPTCHA_CSS_DIR', TENCENT_WORDPRESS_CAPTCHA_URL . 'css' . '/');
...
if (is_file(TENCENT_WORDPRESS_CAPTCHA_DIR . 'theme-adapters/theme-adapters.php')) {
	require_once TENCENT_WORDPRESS_CAPTCHA_DIR . 'theme-adapters/theme-adapters.php';
}
